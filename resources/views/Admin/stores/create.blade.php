...
@section('content')
    ...
    <div class="bg-secondary rounded h-100 p-4 ">
        <form id="form"  method="post" action="{{ route('stores.store') }}">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="storeName" id="storeName" class="form-control" placeholder="Enter Your Store Name">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group" >
                        <strong>Logo:</strong>
                        <input type="file" name="logo" id="logo" class="form-control" style="background-color: #30333a">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
...
<script>
    function checkValidation() {
        ...
        if ($('#storeName').val().trim() == '') {
            toastr.error('Please enterStore  name...');
            return false;
        }
