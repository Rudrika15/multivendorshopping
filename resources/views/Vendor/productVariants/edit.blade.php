...
@section('content')
    ...
    <div class="bg-secondary rounded h-100 p-4 ">
        <form id="form"  method="post" action="{{ route('productVariant.update') }}">
            @csrf
            <input type="hidden" value="{{ $productVariant->id }}" name="productVariantId">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="variantName" id="variantName" class="form-control" placeholder="Enter Variant Name"  value="{{ $productVariant->variantName}}">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="price" id="price" class="form-control" placeholder="Enter Price" value="{{ $productVariant->price}}">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Stock:<sup class="text-danger">*</sup></strong>
                        <input type="text" name="stock" id="stock" class="form-control" placeholder="Enter Stock" value="{{ $productVariant->stock}}">
                    </div>
                </div>
