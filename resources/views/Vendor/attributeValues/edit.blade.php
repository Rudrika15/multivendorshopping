...
@section('content')
    ...
    <div class="bg-secondary rounded h-100 p-4 ">
        <form id="form"  method="post"  action="{{ route('attributeValue.update') }}">
            @csrf
            <input type="hidden" value="{{ $attributeValue->id }}" name="attributeValueId">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="value" id="value" class="form-control" placeholder="Enter Value"  value="{{ $attributeValue->value}}">
                    </div>
                </div>
